...
const (
	...
	AuthServiceName = "mdm.v1.AuthService"
)
...
const (
	...
	AuthServiceLoginProcedure = "/mdm.v1.AuthService/Login"
	// AuthServiceRefreshTokenProcedure is the fully-qualified name of the AuthService's RefreshToken
	// RPC.
	AuthServiceRefreshTokenProcedure = "/mdm.v1.AuthService/RefreshToken"
	// AuthServiceChangePasswordProcedure is the fully-qualified name of the AuthService's
	// ChangePassword RPC.
	AuthServiceChangePasswordProcedure = "/mdm.v1.AuthService/ChangePassword"
)

// AuthServiceClient is a client for the mdm.v1.AuthService service.
...
// NewAuthServiceClient constructs a client for the mdm.v1.AuthService service. By default, it uses
...
func NewAuthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AuthServiceClient {
	...
	authServiceMethods := v1.File_mdm_v1_auth_proto.Services().ByName("AuthService").Methods()
...
// Login calls mdm.v1.AuthService.Login.
func (c *authServiceClient) Login(ctx context.Context, req *connect.Request[v1.LoginRequest]) (*connect.Response[v1.LoginResponse], error) {
	return c.login.CallUnary(ctx, req)
}

// RefreshToken calls mdm.v1.AuthService.RefreshToken.
...
// ChangePassword calls mdm.v1.AuthService.ChangePassword.
...
// AuthServiceHandler is an implementation of the mdm.v1.AuthService service.
...
func NewAuthServiceHandler(svc AuthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/mdm.v1.AuthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAuthServiceHandler) Login(context.Context, *connect.Request[v1.LoginRequest]) (*connect.Response[v1.LoginResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mdm.v1.AuthService.Login is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) RefreshToken(context.Context, *connect.Request[v1.RefreshTokenRequest]) (*connect.Response[v1.RefreshTokenResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mdm.v1.AuthService.RefreshToken is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) ChangePassword(context.Context, *connect.Request[v1.ChangePasswordRequest]) (*connect.Response[v1.ChangePasswordResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mdm.v1.AuthService.ChangePassword is not implemented"))
}
